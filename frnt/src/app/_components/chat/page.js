...
const ChatRoom = ({ roomId }) => {
    ...
    const socket = useMemo(() => io("https://crypto-and-blockchain.onrender.com"), []);
    ...
    return (
       ...
       {/* <div className="flex flex-col h-screen w-screen bg-gradient-to-r from-red-800 to-pink-700 text-white py-2 relative overflow-hidden overflow-y-hidden"> */}
       <div className="flex flex-col h-screen w-screen bg-[#025940] text-white py-2 relative overflow-hidden overflow-y-hidden">

    <div className="h-[800px] w-[800px] bg-blue-800 rounded-full blur-3xl opacity-25 absolute bottom-0 -left-32"></div>
    ...
    <div className="max-w-screen-xl w-full mx-auto rounded-xl relative z-10 lg:px-0 px-2">


        <div className="flex w-full items-center justify-between lg:py-5 py-2 px-5 bg-blue-300 rounded-xl z-20">
            <div className="flex items-center space-x-3">
                {videoId ? (
                    <div>
                        <span>{videoTitle?.length > 20 ? videoTitle?.slice(0, 20) : ""}</span>
                        <button
                            // className={`px-4 py-2 ${isPlaying ? "bg-blue-900" : "bg-blue-300"} text-white rounded-lg`}
                            // className={`px-4 py-2 bg-blue-600 text-white rounded-xl`}
                            className={`px-4 py-2 ml-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition duration-300`}
            ...
            <Image src="/123l.png" alt="music" width={60} height={60} className="cursor-pointer" onClick={() => setmodal(true)} />
        </div>
        ...
        {/* <div className="lg:h-[520px] h-[500px] overflow-y-scroll scrollbar-hide flex flex-col gap-4 py-10 lg:px-8 px-2 rounded-xl z-10" ref={scroll}> */}
        <div className="lg:h-[520px] h-[500px] overflow-y-scroll flex flex-col gap-4 py-10 lg:px-8 px-2 rounded-xl z-10 scroll-hidden" ref={scroll}>
            ...
            {chat.map((msg, index) => (
                ...
                >
                    ...
                    <div
                        className={`py-2 px-4 max-w-xs rounded-lg ${msg.senderId === userId ? "bg-blue-400 text-white" : "bg-blue-300"}`}
                    >
        ...
        <div className="flex flex-row items-center space-x-5">
            ...
            <button
                ...
                className="px-6 mt-2 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600"
            >
                Send
            </button>
        </div>
