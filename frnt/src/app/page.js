...
const Page = () => {
 ...
 const [roomId, setroomId] = useState("")
  ...
  <div className="w-full h-full bg-gradient-to-r from-purple-500 via-blue-500 to-green-500 overflow-hidden">
     ...
     <div className=' flex items-center justify-center max-w-screen-xl flex-col space-y-6 mx-auto h-screen'>
      <div className=' max-w-screen-xl mx-auto flex items-center flex-col justify-center relative z-20'>
        {/* <h1 className='lg:text-[130px]  font-bold text-transparent bg-clip-text bg-gradient-to-r font-serif from-purple-500 to-purple-400 z-20'>Love You Na</h1> */}
        {/* <h1 className="lg:text-[130px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 font-serif z-20">
  Love You Forever
</h1> */}
<motion.h1 
  ...
  className="lg:text-[130px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 font-serif z-20 transition-all duration-500 ease-in-out"
>
  Love You Forever
</motion.h1>
...
<motion.h1 
  ...
  className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-red-500 to-purple-500 text-center font-extrabold lg:text-4xl text-xl"
>
  ❤️ Where Love and Music Sync in Harmony 🎶
</motion.h1>
